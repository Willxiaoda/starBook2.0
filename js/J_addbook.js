	function turnOn(eid){
			if (confirm("你确定删除么？")) {
				...
				window.location.href="deletelist.html?listID="+ eid +"   ";
	...
	window.onload=function(){
		...
		for(var i = 0; i < data.length; i++){
			...
			//内容并在li中添加a标签
			bookNameLi.innerHTML = "<a href='bookCollect.html?listID="+data[i].id+"'> "+ data[i].listname + "</a> ";
			if(data[i].listhref!=""){
			...
			Compile.innerHTML = "<a href='BookEdit.html?listID="+data[i].id+"'>编辑</a>";
